...
CREATE TABLE `ExamCycle` (
    ...
    `batchSemesterId` VARCHAR(191) NOT NULL,
    ...
    INDEX `ExamCycle_batchSemesterId_idx`(`batchSemesterId`),
    UNIQUE INDEX `ExamCycle_batchSemesterId_examType_key`(`batchSemesterId`, `examType`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `QuestionRevision` (
    ...
    `snapshotQuestionText` TEXT NOT NULL,
...
CREATE TABLE `QuestionUsageHistory` (
    ...
    INDEX `QuestionUsageHistory_sourceType_sourceId_idx`(`sourceType`, `sourceId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ApprovalDecision` (
    ...
    UNIQUE INDEX `ApprovalDecision_questionBankId_key`(`questionBankId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DeanReview` (
    `id` VARCHAR(191) NOT NULL,
    `questionBankId` VARCHAR(191) NOT NULL,
    `regularPaper` ENUM('PAPER_A', 'PAPER_B', 'PAPER_C') NOT NULL,
    `supplementaryPaper` ENUM('PAPER_A', 'PAPER_B', 'PAPER_C') NOT NULL,
    `ktPaper` ENUM('PAPER_A', 'PAPER_B', 'PAPER_C') NOT NULL,
...
CREATE TABLE `Batch` (
    ...
    `hasTeachingGroups` BOOLEAN NOT NULL DEFAULT false,
    `currentBatchSemesterId` VARCHAR(191) NULL,
    `currentSemesterNumber` INTEGER NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `Batch_code_key`(`code`),
    INDEX `Batch_currentBatchSemesterId_idx`(`currentBatchSemesterId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ExamCycle` ADD CONSTRAINT `ExamCycle_batchSemesterId_fkey` FOREIGN KEY (`batchSemesterId`) REFERENCES `BatchSemester`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `QuestionOwnershipHistory` ADD CONSTRAINT `QuestionOwnershipHistory_questionId_fkey` FOREIGN KEY (`questionId`) REFERENCES `QuestionLibraryItem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `QuestionRevision` ADD CONSTRAINT `QuestionRevision_questionId_fkey` FOREIGN KEY (`questionId`) REFERENCES `QuestionLibraryItem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `QuestionUsageHistory` ADD CONSTRAINT `QuestionUsageHistory_questionId_fkey` FOREIGN KEY (`questionId`) REFERENCES `QuestionLibraryItem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `QuestionBankSnapshot` ADD CONSTRAINT `QuestionBankSnapshot_questionBankId_fkey` FOREIGN KEY (`questionBankId`) REFERENCES `QuestionBank`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `GeneratedPaperItem` ADD CONSTRAINT `GeneratedPaperItem_generatedPaperId_fkey` FOREIGN KEY (`generatedPaperId`) REFERENCES `GeneratedPaper`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
