...
flowchart TD
    ...
    D --> E["Batch Semester Activated"]
    E --> F["Question Banks & Exam Cycles<br/>Auto-Created"]
    F --> G["Contributors & Moderators<br/>Assigned"]
    G --> H["Questions Written & Submitted"]
    H --> I["Moderation & Revision Cycle"]
    I --> J["AI Analysis"]
    J --> K["Paper Generation (A, B, C)"]
    K --> L["Dean Review & Selection"]
    L --> M["Export Final Papers"]
```
