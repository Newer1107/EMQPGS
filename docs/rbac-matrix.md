...
| --- | --- | --- | --- | --- | --- |
| Login, logout, refresh | Yes | Yes | Yes | Yes | Yes |
...
| View all generated papers | Yes | Read | Read | No | Yes |
| Submit dean selections | No | No | No | No | Yes |
| View dean selections | Yes | Read | No | No | Yes |
| Export PDF/DOCX/ZIP | Yes | No | No | No | No |
| Trigger backup | Yes | No | No | No | No |
| View monitoring dashboard | Yes | No | No | No | No |
