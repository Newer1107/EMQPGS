...
export const SECURITY_EVENT_ID = "SECURITY_EVENT_ID";
...
/** Security audit event actions for the AuditService. */
export const SECURITY_ACTIONS = {
  OTP_REQUESTED: "OTP_REQUESTED",
  OTP_VERIFIED: "OTP_VERIFIED",
  OTP_FAILED: "OTP_FAILED",
  PAPER_REVEALED: "PAPER_REVEALED",
  PAPER_DOWNLOADED: "PAPER_DOWNLOADED",
  PAPER_REGENERATED: "PAPER_REGENERATED",
  PAPER_APPROVED: "PAPER_APPROVED",
  PAPER_MARKED_USED: "PAPER_MARKED_USED",
  QUESTIONS_REVEALED: "QUESTIONS_REVEALED",
  SECURITY_CONFIG_CHANGED: "SECURITY_CONFIG_CHANGED",
  STEP_UP_SESSION_CREATED: "STEP_UP_SESSION_CREATED",
  STEP_UP_SESSION_EXPIRED: "STEP_UP_SESSION_EXPIRED",
  LOCKDOWN_ACTIVATED: "LOCKDOWN_ACTIVATED",
  LOCKDOWN_DEACTIVATED: "LOCKDOWN_DEACTIVATED",
  DOWNLOAD_DISABLED: "DOWNLOAD_DISABLED",
  EMERGENCY_OVERRIDE: "EMERGENCY_OVERRIDE",
  // Two-person emergency approval workflow
...
/** OTP purposes — each authorizes ONE specific action on ONE resource. */
export const OTP_PURPOSES = {
  DEAN_REVEAL: "DEAN_REVEAL",
  DEAN_APPROVE: "DEAN_APPROVE",
  COE_DOWNLOAD: "COE_DOWNLOAD",
  COE_MARK_USED: "COE_MARK_USED",
  COE_ARCHIVE: "COE_ARCHIVE",
  COE_EXPORT: "COE_EXPORT",
} as const;

/** Typed confirmation words for sensitive actions. */
