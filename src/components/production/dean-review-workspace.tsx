            ...
            <Card key={paper.paperId} className="overflow-hidden">
              ...
              <CardContent className="space-y-5">
                ...
                <div className="flex gap-2">
                  <a
                    href={`/api/question-banks/${questionBankId}/papers/${paper.paperId}/export?format=docx`}
                  ...
                  <a
                    href={`/api/question-banks/${questionBankId}/papers/${paper.paperId}/export?format=pdf`}
                    className="inline-flex items-center justify-center rounded-md border border-[var(--border)] px-3 py-2 text-xs font-medium hover:bg-[var(--surface-hover)] transition-colors"
                    download
                  >
                    Download PDF
                  </a>
